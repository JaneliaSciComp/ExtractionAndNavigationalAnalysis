...
#py 2.1.CreateMatFilesJobs-ZlaticTest.py || error_exit "Step 2.1 (Zlatic-specific) failed, exiting."
#/groups/zlatic/zlaticlab/code/choreography_plots/check_bjobs.pl -t 20 -l -r

echo "Before step 2.2" at `date`
py 2.2.PrepareFilesForNavigationalAnalysis-ProjectsTest.py || error_exit "Step 2.2 failed, exiting."
exit
